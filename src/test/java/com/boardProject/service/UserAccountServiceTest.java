...
class UserAccountServiceTest {
    ...
    @Test
    void givenNonexistenUserId_whenSearching_thenReturnsOptionalUserData() {
        // Given
    ...
    void givenUserParams_whenSaving_thenSavesUserAccount() {
        // Given
        UserAccount userAccount = createUserAccount("joosang");
        UserAccount savedUserAccount = createSigningUpUserAccount("joosang");
